...
export default function ContactCTA({ carName }: ContactCTAProps) {
  return (
    <div className={styles.container}>
      ...
      <p className={styles.subtitle}>Contactanos y te ayudamos a conseguir tu próximo auto</p>

      <div className={styles.actions}>
        <a href={`https://wa.me/${phoneNumber}?text=${whatsappMessage}`} target="_blank" rel="noopener noreferrer" className={styles.whatsappButton}>
